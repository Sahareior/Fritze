...
const NavAboutCTA = () => {
  return (
    <section>
      ...
      {/* ================= DARK SECTION ================= */}
      <div className="bg-[#2f3e46] text-white py-12 md:py-16 text-center px-4 md:px-6">
        
        <div className="max-w-3xl mx-auto">
          
          {/* Title */}
          <h2 className="font-bold text-[28px] md:text-[36px] mb-4">
            Our Tour Philosophy
          </h2>
          ...
          <div className="bg-white/10 border border-white/10 rounded-xl p-5">
            ...
            <p className="text-[14px] md:text-[16px] font-bold text-gray-400">
      ...
      {/* ================= LIGHT CTA ================= */}
      <div className="bg-[#f3f3f3] py-12 md:py-14 text-center px-4 md:px-6">
        
        <div className=" mx-auto">
          
          {/* Title */}
          <h3 className="font-bold text-[28px] md:text-[36px] text-gray-800 mb-2">
            Join Our Journey
          </h3>

          {/* Subtitle */}
          <p className="text-[16px] md:text-[20px] text-[#4A5565] mb-6">
            Experience the future of city tours. Book your first CineWalk adventure today.
          </p>

          {/* Button */}
          <button className="bg-orange-500 text-white px-6 py-3 rounded-md hover:bg-orange-600 transition w-full md:w-auto">
            Explore Experiences
          </button>
