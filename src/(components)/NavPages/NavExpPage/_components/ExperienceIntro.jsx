  ...
  return (
    <section className="space-y-10 ">
      ...
      <div>
        ...
        <h2 className="font-serif lora text-[42px] font-semibold text-[#2A3C48] mb-3">
          The Experience
        </h2>

        <p className="text-[18px]  text-gray-600 leading-relaxed raleway">
      ...
      <div className="bg-[#F9F9F9] rounded-xl p-6 shadow-sm ">
        <h3 className="text-[20px] font-semibold raleway text-gray-700 mb-4">
          What’s Included:
        </h3>

        <div className="grid md:grid-cols-2 gap-4">
          {includedItems.map((item, index) => (
            <div key={index} className="flex items-start raleway text-[16px] gap-2 text-gray-600">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {features.map((item, index) => (
            ...
            >
              ...
              <p className="text-[16px] raleway text-gray-600">{item.text}</p>
            </div>
          ))}
        </div>
      </div>
