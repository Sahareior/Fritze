      ...
      <div className="max-w-8xl mx-auto px-20">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-2 space-y-16">
            ...
            {/* Photo & Video Gallery */}
            <div>
              <h2 className="lora text-[36px] font-semibold text-[#2A3C48] mb-8">
                Photo & Video Gallery
              </h2>
              
              <div className="grid md:grid-cols-2 gap-6">
                {/* Photo Card */}
                <div className="bg-white rounded-2xl shadow-sm p-8 flex flex-col hover:shadow-md transition border border-gray-100">
                  ...
                  <button className="mt-auto flex items-center gap-2 text-orange-500 font-bold raleway text-sm hover:underline">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-10 border border-gray-100">
                <div className="flex flex-col md:flex-row gap-10">
                  ...
                  <div className="flex flex-col">
                    <h3 className="lora text-[32px] font-bold text-gray-800 mb-1">
                      Maria Rodriguez
                    </h3>
                    <p className="raleway text-[18px] font-medium text-orange-500 mb-6">
                      Founder & Chief Storyteller
                    </p>
                    
                    <div className="raleway text-[16px] max-w-[400px] text-gray-500 space-y-4  mb-8 leading-relaxed">
                      <p>
          ...
          <div className="space-y-10">
            ...
            {/* Recent Coverage */}
            <div className="bg-white mt-[80px] rounded-2xl shadow-sm p-8 border border-gray-100">
              <h2 className="lora text-[24px] font-semibold text-[#2A3C48] mb-8">
                Recent Coverage
              </h2>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="space-y-3 text-[14px] raleway">
